""" In ABC premier league, there are 10 teams. This program generates
fixtures for these teams to play during each weekend"""
import json

# Defining the teams and their local towns. By Jossy
teams = ["CKlein Stars", "Dolphins FC",
         "Wolves FC", "Sea Horses FC",
         "Sharks United", "Lake Basin FC",
         "Thika United", "Mavuno Comrades FC",
         "Nakuru FC", "Ostrich Associates"]
...
teams = sorted(teams, key=lambda team: teams_local_towns[team])


# Generating the round-robin fixtures By Josh
def generate_round_robin_fixtures(teams):
    ...
    for i in range(len(teams) - 1):
        stadium = teams_local_towns + " Stadium"
...
# Organizing the fixtures into weekends
...
# Generating the final table By Ryan
...
# Writing the final table to a JSON file
